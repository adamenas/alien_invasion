...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        if not recorde.is_file():
            recorde.write_text('0')
        pygame.init()
        self.clock = pygame.time.Clock()
        self.settings = Settings()
        
        self.screen = pygame.display.set_mode((self.settings.screen_width, self.settings.screen_height))
        # bloco ABAIXO substitui o DE CIMA
        # muda o tamanho da tela para FULLSCREEN
